...
FNN2, FNN3, RNN2, Bidirectional LSTM with attention, transformer4 aswell as transformer5 were the chosen models. They were chosen so that all major different architectures were used. The strongest performing models (of the ones considered in this project) were chosen for each architecture.
