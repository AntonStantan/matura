...
In the notebook \href{https://github.com/AntonStantan/matura/blob/main/FNN/FNN3.ipynb}
{FNN3} a positional embedding layer is added to the model and a keras tuner 
tunes the hyper parameters of the model to an optimum. The formula used, is the 
one from \cite{vaswani2023attentionneed}. A similar performance to the notebook 
FNN2 is observed.
